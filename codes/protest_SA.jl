...
# ╔═╡ 8fb15f54-07b0-4fa4-a73c-e489056e8029
md"""
...
# ╔═╡ bddffc02-497d-43be-994e-e8439cee7046
begin
...
# ╔═╡ 94766dcc-5e85-45d9-9b37-f5e87e576446
begin
	protest_raster = rasterize(sum, protests[:,[:geometry,:event_w]]; res = .7, boundary=:touches, fill = :event_w)
